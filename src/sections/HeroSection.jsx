...
export default function HeroSection() {
    return (
        <div className="flex flex-col items-center justify-center text-center bg-[url('/assets/hero-section-dot-image.png')] bg-cover bg-no-repeat">
            ...
            <p className="text-base text-slate-600 max-w-lg mt-5">Connect candidates and employers in one place — from posting to offer, simple and seamless.</p>
            ...
            <img className="w-5/6 max-w-sm mt-16 drop-shadow-2xl drop-shadow-blue-500/15 mx-auto" src="/public/assets/hero-section-card-image.svg" alt="Hero Section Card Image" width={1000} height={500} fetchPriority="high" />
        </div>
    );
}