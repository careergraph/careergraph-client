...
function CardSection() {
    ...
    return ( <div ref={divRef} onMouseMove={handleMouseMove} onMouseEnter={() => setVisible(true)} onMouseLeave={() => setVisible(false)}
            className="relative w-80 h-96 rounded-xl p-px bg-white backdrop-blur-md text-gray-800 overflow-hidden shadow-lg cursor-pointer"
        >
            ...
            <div className="relative z-10 bg-white  /75 p-6 h-full w-full rounded-[11px] flex flex-col items-center justify-center text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-1">Richard Nelson</h2>
