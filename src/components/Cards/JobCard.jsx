...
export default function JobCard() {
  return (
    <div className="relative flex gap-4 border border-slate-200 rounded-xl p-4 shadow-sm hover:shadow-md transition bg-white">
      {/* Icon nổi bật */}
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start gap-4">
          ...
          <div className="flex flex-col items-end gap-2 shrink-0">
            ...
            <button className="mt-1 inline-flex items-center justify-center px-3 py-1.5 text-sm rounded-md border border-slate-200 text-slate-700 hover:bg-slate-50">
              Save
            </button>
            <button className="mt-1 inline-flex items-center justify-center px-3 py-1.5 text-sm rounded-md border border-slate-200 text-slate-700 hover:bg-slate-50">
              Detail
